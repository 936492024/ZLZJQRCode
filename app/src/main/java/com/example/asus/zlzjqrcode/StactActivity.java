...
public class StactActivity extends Activity implements EasyPermissions.PermissionCallbacks,MainView {
    ...
    private ImageView qr_code_btn;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stact);
        StatusBarUtils.with(this)
                .init();
        qr_code_btn= (ImageView) findViewById(R.id.qr_code_btn);
        qr_code_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StactActivity.this,SecondActivity.class);
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(StactActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
                ...
                try {
                    CodeUtils.analyzeBitmap(ImageUtil.getImageAbsolutePath(this, uri), new CodeUtils.AnalyzeCallback() {
                        ...
                        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
                            Toast.makeText(StactActivity.this, "解析结果:" + result, Toast.LENGTH_LONG).show();
                        }
    ...
    private void onClick(int buttonId) {
        switch (buttonId) {
            case R.id.button1:
                ...
                break;
            case R.id.button3:
                intent = new Intent(StactActivity.this, SecondActivity.class);
                startActivityForResult(intent, REQUEST_CODE);
                break;
            default:
                break;
