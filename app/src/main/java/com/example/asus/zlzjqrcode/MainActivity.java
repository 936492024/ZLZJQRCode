...
import com.example.asus.zlzjqrcode.utils.CheckPermissionUtils;
...
public class MainActivity extends Activity implements EasyPermissions.PermissionCallbacks,MainView{
    ...
    class ButtonOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.button2) {
                ...
                mBitmap = CodeUtils.createImage("我的二维码", 400, 400, BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher));
